...
export const featuredTitleText = () => {
  return (
    <>
      ...
      >
        This App is built as a workout companion for the Apple watch, meant to
        track meaningful metrics in the gym. This is targeted at gym goers with
...
export const skillsArray = [
  ...
  },
  {
    ...
    desc:
      "By integrating with powerful analytics tools, clients are able to track dozens of valuable data points in real time. This can provide insight into which marketing strategies are providing the highest ROE, the on-site behavior of each visitor, and be integrated with both Google's own dashboard, as well as a custom built Admin dashboard that only you will have access.",
  },
  {
    index: 3,
    classIndex: "four",
